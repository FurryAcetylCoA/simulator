...
dutName ?= ysyx3
# Select which model to drive in emu.cpp (0=gsim,1=verilator,2=both)
MODE ?= 0
mainargs ?= ready-to-run/bin/linux.bin
# uncomment following line to let this file be part of dependency of each .o file
...
### When MODE=2 this is instead handled by next block
##############################################
